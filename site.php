...
$app->post("/checkout", function(){
	...
	//switch ((int)$_POST['payment-method']) {
		...
		//case 2:
		//header("Location: /php7-ecommerce/index.php/order/".$order->getidorder()."/paypal");
		//break;
...
$app->get("/boleto/:idorder", function($idorder){
	...
	//var_dump($valor_cobrado); // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
	...
	// NÃO ALTERAR!
	$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "php7-ecommerce" . DIRECTORY_SEPARATOR . "res" . DIRECTORY_SEPARATOR . "boletophp" . DIRECTORY_SEPARATOR . "include" . DIRECTORY_SEPARATOR;
...
$app->post("/profile/change-password", function(){
	...
	if (!isset($_POST["current_pass"]) || $_POST["current_pass"] === "") {
		...
		header("Location: /php7-ecommerce/index.php/profile/change-password");
		exit;
