            ...
            <div class="col-md-12">
                <div class="product-content-right">
                    <div class="product-breadcroumb">
                        <a href="/php7-ecommerce/index.php/">Home</a>
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <div class="product-inner-category">
                                    <p>Categories<?php $counter1=-1;  if( isset($categories) && ( is_array($categories) || $categories instanceof Traversable ) && sizeof($categories) ) foreach( $categories as $key1 => $value1 ){ $counter1++; ?><a href="/php7-ecommerce/index.php/categories/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
